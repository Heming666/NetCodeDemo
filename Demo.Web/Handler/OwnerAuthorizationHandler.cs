...
{
    public class OwnerAuthorizationHandler : AuthorizationHandler<OperationAuthorizationRequirement, IdentityUser>
    {
        ...
        /// 构造函数注入
        /// </summary>
        public OwnerAuthorizationHandler(IAuthenticationSchemeProvider schemes, IDistributedCache cacheService)
        {
            Schemes = schemes;
        ...
        // 重载异步处理程序
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, IdentityUser resource)
        {
