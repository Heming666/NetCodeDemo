    ...
    public class MySqlDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserEntity>(entity =>
            {
                ...
                entity.HasOne(x => x.DeptInfo).WithMany(p => p.Users).HasForeignKey(x=>x.DeptId);
            ...
            modelBuilder.Entity<ConsumeEntity>(entity => {
                entity.ToTable("User_ConsumeEntity").HasOne(x => x.User).WithMany(x => x.ConsumeEntitys).HasForeignKey(x=>x.UserId);
